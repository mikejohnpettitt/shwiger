...
ActiveRecord::Schema[7.2].define(version: 2026_02_03_072617) do
  ...
  create_table "tts_clips", force: :cascade do |t|
    t.string "digest", null: false
    t.text "text", null: false
    t.string "language_code", default: "cmn-CN", null: false
    t.string "voice_name", default: "cmn-CN-Wavenet-A", null: false
    t.float "speaking_rate", default: 1.0, null: false
    t.integer "status", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["digest"], name: "index_tts_clips_on_digest", unique: true
  end
